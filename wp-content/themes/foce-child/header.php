		...
		<nav id="site-navigation" class="main-navigation">
            ...
            <div class="opened-menu">
                <div class="images-menu">
                    <img src="<?php echo get_stylesheet_directory_uri() . '/assets/images/cat-orange.png'; ?> " alt="Chat orange" class="chat orange">
                    <img src="<?php echo get_stylesheet_directory_uri() . '/assets/images/cat-black.png'; ?> " alt="Chat noir" class="chat noir">
                    <img src="<?php echo get_stylesheet_directory_uri() . '/assets/images/cat-blue.png'; ?> " alt="Chat bleu" class="chat bleu">
                    <img src="<?php echo get_template_directory_uri() . '/assets/images/random_flower.png'; ?> " alt="Fleur mauve" class="fleur mauve">
                    ...
                    <img src="<?php echo get_template_directory_uri() . '/assets/images/flower.png'; ?> " alt="Fleur orange" class="fleur jaune">
                </div>
                <div class="menu-img">
